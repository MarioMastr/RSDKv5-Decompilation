...
void RSDK::SKU::InputDeviceSDL::UpdateInput()
{
    ...
    int32 keyMasks[] = { SDL_SCANCODE_UP, SDL_SCANCODE_DOWN, SDL_SCANCODE_LEFT,  SDL_SCANCODE_RIGHT,  SDL_SCANCODE_A,      SDL_SCANCODE_B,      SDL_SCANCODE_C,       SDL_SCANCODE_X,
                         SDL_SCANCODE_Y,  SDL_SCANCODE_Z,    KEYMASK_START, KEYMASK_SELECT, KEYMASK_STICKL, KEYMASK_STICKR, KEYMASK_BUMPERL, KEYMASK_BUMPERR };
